...
mod tests {
    ...
    fn run_with_default_config() {
        run(None, None, None, None, None, None, None, false);
    }

    #[test]
    fn run_to_json() {
        run(None, None, None, None, None, None, None, true);
    }

    #[test]
    fn run_with_o_spectral_class() {
        run(None, Some(60.0), None, None, None, None, None, false);
    }

    #[test]
    fn run_with_b_spectral_class() {
        run(None, Some(18.0), None, None, None, None, None, false);
    }

    #[test]
    fn run_with_a_spectral_class() {
        run(None, Some(2.1), None, None, None, None, None, false);
    }

    #[test]
    fn run_with_f_spectral_class() {
        run(None, Some(1.3), None, None, None, None, None, false);
    }

    #[test]
    fn run_with_g_spectral_class() {
        run(None, Some(1.0), None, None, None, None, None, false);
    }

    #[test]
    fn run_with_k_spectral_class() {
        run(None, Some(0.8), None, None, None, None, None, false);
    }

    #[test]
    fn run_with_m_spectral_class() {
        run(None, Some(0.3), None, None, None, None, None, false);
    }

    #[test]
    fn run_with_brown_dwarf() {
        run(None, Some(0.1), None, None, None, None, None, false);
    }

    #[test]
    fn run_with_rogue_planet() {
        run(None, Some(0.0005), None, None, None, None, None, false);
    }

    #[test]
    fn planets_limit() {
        run(Some(5), None, None, None, None, None, None, false);
    }
    ...
    fn high_density_dust() {
        run(None, None, Some(0.05), None, None, None, None, false);
    }

    #[test]
    fn low_density_dust() {
        run(None, None, Some(0.00125), Some(25.0), None, None, None, false);
    }

    #[test]
    fn high_cloud_ecentricity() {
        run(None, None, None, None, Some(0.5), None, None, false);
    }

    #[test]
    fn low_cloud_ecentricity() {
        run(None, None, None, None, Some(0.1), None, None, false);
    }

    #[test]
    fn low_cloud_ecentricity_and_dust_density() {
        run(None, None, Some(0.035), None, Some(0.05), None, None, false);
    }
}
