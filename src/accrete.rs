...
impl Accrete {
    pub fn new(
        ...
        let stellar_luminosity = astro::luminosity(&stellar_mass);
        let planets = Vec::new();
    ...
    pub fn distribute_planets(&mut self) {
        ...
        while dust_left {
            let mut p = Planetismal::new(&stellar_mass, consts::PROTOPLANET_MASS);
            ...
            if mass != 0.0 && mass != consts::PROTOPLANET_MASS { 
