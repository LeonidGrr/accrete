...
* @returns {any}
*/
export function planetary_system(seed, stellar_mass) {
    uint64CvtShim[0] = seed;
    const low0 = u32CvtShim[0];
    const high0 = u32CvtShim[1];
    const ret = wasm.planetary_system(low0, high0, stellar_mass);
...
* @returns {any}
*/
export function planet(seed, stellar_mass) {
    uint64CvtShim[0] = seed;
    const low0 = u32CvtShim[0];
    const high0 = u32CvtShim[1];
    const ret = wasm.planet(low0, high0, stellar_mass);
    return takeObject(ret);
}
